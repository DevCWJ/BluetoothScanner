...
namespace System.IO.Extension
{
    ...
    /// as much as possible so that you can use SafeFileSystemWatcher instead
    /// of FileSystemWatcher objects.
    /// SafeFileSystemWatcher will capture all events from the FileSystemWatcher object.
    ...
    /// *The event is triggered only when the file being modified is completely closed.
    /// 
    /// </summary>
    public class SafeFileSystemWatcher : IDisposable
    {
        ...
        public SafeFileSystemWatcher(string path)
        {
