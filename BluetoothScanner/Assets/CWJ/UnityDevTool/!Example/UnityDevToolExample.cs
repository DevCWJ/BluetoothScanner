...
#pragma warning disable
        ...
        [SerializeField, ErrorIfNull] private string requiredStrs;
        ...
        private void Start()
        {
            ...
            CWJ_Debug.LogError(rangedFloat.LerpFromRange(1));
        }
        ...
        {
            return flagTest.HasFlag(EFlagTest.Action);
        }
