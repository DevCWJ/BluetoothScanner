...
namespace CWJ.AccessibleEditor
{
    ...
    public class UnityEventDrawerEx : UnityEventDrawer, CWJ.AccessibleEditor.INewPropertyDrawer
    {
        ...
        static readonly FieldInfo s_FiRuntimeCalls = EventUtil.T_InvokableCallList.GetField("m_RuntimeCalls", kBfAll);
        ...
        public static IList GetRuntimeCalls(SerializedProperty property)
        {
            ...
            return propertyInstance != null
                ? s_FiRuntimeCalls.GetValue(EventUtil.F_Calls.GetValue(propertyInstance)) as IList
