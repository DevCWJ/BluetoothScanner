...
namespace CWJ.AccessibleEditor.DebugSetting
{
    ...
    {
        public static string GetLogFolderPath => AccessibleEditorUtil.GetPersistentDataPath + "/CWJ_LOG/";

        public static string GetEditorLogFolderPath => Application.persistentDataPath + "/CWJ_LOG_editor/";
        ...
        private static void StartLogMsgWrite()
        {
            ...
            {
                UnityEngine.Debug.LogError("DebugLogWriter Error - 폴더를 찾거나 생성할수 없음" + LogFolderPath);
                return;
            }
