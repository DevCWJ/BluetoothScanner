...
namespace CWJ
{
    ...
    public class CoroutineTracked : IDisposable
    {
        ...
        [Readonly] private bool _isRunning_correctly;
        public bool isRunningWhatToDo => _isRunning_correctly;
        ...
        public CoroutineTracked(string nameForClassify = null, bool? isNotStartWhenAlreadyRunning = null)
        {
            ...
            if (isNotStartWhenAlreadyRunning != null)
                this.isCantStartWhenAlreadyRunning = isNotStartWhenAlreadyRunning.Value;
        }

        public void SetSettings(MonoBehaviour monoBehaviour, string nameForClassify, bool? isNotStartWhenAlreadyRunning, bool forcedStop = false)
        {
            if (nameForClassify != null)
                name = nameForClassify;
            if (isNotStartWhenAlreadyRunning != null)
        ...
        public IEnumerator Routine(MonoBehaviour monoBehaviour, IEnumerator enumerator)
        {
            _isRunning_correctly = true;
            ...
            doCoroutine = null;
            _isRunning_frameSafely = _isRunning_correctly = false;
