...
namespace CWJ.AccessibleEditor
{
    ...
    public interface INewPropertyDrawer
    {
    ...
    public static partial class EditorGUI_CWJ
    {
        ...
        public static readonly Type TypeOfSerializedDictionaryInterface = typeof(IEditableDictionary);
        ...
        public static readonly UnityEventDrawerEx UnityEventDrawer = new UnityEventDrawerEx();
        public static readonly DisplayScriptableObjectDrawer ScriptableObjDrawer = new DisplayScriptableObjectDrawer();
        ...
        //}
        static Dictionary<Type, INewPropertyDrawer> TypeOfNewPropertyDrawerDic = new Dictionary<Type, INewPropertyDrawer>();
        ...
        public struct MemberAttributeCache
        {
            ...
            public readonly bool isHideAlways;
            ...
            public MemberAttributeCache(MemberInfo memberInfo, Type memberType, object targetObj, NewPropertyDrawHandler _drawFunc = null, bool needDraw = true)
            {
                ...
                if (!TypeOfNewPropertyDrawerDic.TryGetValue(memberType, out INewPropertyDrawer newPropertyDrawer))
                {
                    if (TypeOfUnityEventBase.IsAssignableFrom(memberType))
                        newPropertyDrawer = UnityEventDrawer;
                    else if (TypeOfScriptableObject.IsAssignableFrom(memberType))
                        newPropertyDrawer = ScriptableObjDrawer;
                    //else if ...
                    //else if ...
                    if (newPropertyDrawer != null)
                        TypeOfNewPropertyDrawerDic.Add(memberType, newPropertyDrawer);
                }

                if (newPropertyDrawer != null)
                    this.drawFunc = newPropertyDrawer.Draw;
                //else
                //{
