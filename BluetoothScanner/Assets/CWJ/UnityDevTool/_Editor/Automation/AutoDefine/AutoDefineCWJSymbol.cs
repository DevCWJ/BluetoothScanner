...
namespace CWJ.EditorOnly
{
    ...
    public static class AutoDefineCWJSymbol
    {
        ...
        private const string RuntimeDebuggingToolFolder = "RuntimeDebuggingTool";
        ...
        public static void InitializeOnLoad()
        {
            ...
            CWJ_EditorEventHelper.ReloadedScriptEvent += OnReloadedCheckFolder;
            CWJ_EditorEventHelper.FolderChangedEvent += OnReloadedCheckFolder;
        }
        ...
        private static void OnReloadedCheckFolder()
        {
        ...
        private static void CheckDefineSymbol(bool isProjectInit)
        {
            ...
            DefineSymbolWhenExists(CwjFolderNames?.IsExists(RuntimeDebuggingToolFolder) ?? false,
        ...
        private static void DefineSymbolWhenExists(bool isExists, bool isSymbolDefined, string symbolName, Action<bool> callback = null)
        {
            if (isExists != isSymbolDefined)
            {
                if (isExists)
